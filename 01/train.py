...
print("\n[STEP] #01 - Short review")
print("length of dataset in characters: ", len(text))
print(text[:1000])

print("\n[STEP] #02 - Store all unique characters found in text")
...
print("\n[STEP] #03 - Create Mapping from characters to integers")
...
print("\n[STEP] #04 - Initial check of train/validation set and target values.")
...
print("\n[STEP] #06 - Neural Network (Bigram Language Model)")
import torch
